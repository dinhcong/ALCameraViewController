Pod::Spec.new do |spec|
  spec.name               = "dinhcong/ALCameraViewController"
  spec.version            = "1.0"
  spec.summary            = "A camera view controller with custom image picker and image cropping. Written in Swift."
  spec.source             = { :git => "https://github.com/dinhcong/ALCameraViewController.git", :tag => spec.version.to_s }
  ...
  spec.homepage           = "https://github.com/dinhcong/ALCameraViewController"
  spec.author             = { "Cong Dinh" => "thcong.dinh@gmail.com" }
end
